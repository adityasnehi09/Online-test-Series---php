...
else
{
	...
	{ 
		...
		$total_seatX=mysqli_real_escape_string($con,$_POST['total_seat']);
		$heading1X=mysqli_real_escape_string($con,$_POST['heading1']);
		$heading2X=mysqli_real_escape_string($con,$_POST['heading2']);
		$heading3X=mysqli_real_escape_string($con,$_POST['heading2']);
		$include_incompX=mysqli_real_escape_string($con,$_POST['include_incomp']);
		$opening_statusX=mysqli_real_escape_string($con,$_POST['opening_status']);
        ...
        $banner_img= mysqli_real_escape_string($con,$_FILES['banner_img']['name']);
