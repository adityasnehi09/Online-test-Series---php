    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Send Mail
						<?php 
			   ...
			   <div class="col-md-12">
                    <div class="form-group"> 
                       ...
                       <textarea rows="5" name="f2" class="form-control"></textarea>
                    </div>
               </div>
			    <div class="col-md-12">
                    <div class="form-group"> 
                        <label>Image | F3</label>
                        <input type="file" name="f3" class="form-control">
                    </div>
               </div>
			   ...
			   <div class="col-md-12">
			    ...
			    <div class="col-md-12">
                    <div class="form-group"> 
                        ...
                        <input type="text" name="f8" class="form-control"value="Click Here">
                    </div>
               </div>
			    ...
			    <div class="col-md-12">
                    <div class="form-group"> 
                        ...
                        <input type="text" name="f10" class="form-control"value="https://www.facebook.com/nightbirdplatform/"required>
                    </div>
               </div>
			    ...
			    <div class="col-md-12">
                    <div class="form-group"> 
                        ...
                        <input type="text" name="f13" class="form-control"value="9814916810" required>
                    </div>
               </div>
			    <div class="col-md-12">
                    <div class="form-group"> 
                        <label>Email | F14</label>
                        <input type="text" name="f14" class="form-control"value="info@nightbird.com"required>
                    </div>
               </div>
			    <div class="col-md-12">
                    <div class="form-group"> 
			  ...
			  <H2>Email Detail</h2>
			   <div class="col-md-12">
				...
				<div class="col-md-12">
                    <div class="form-group"> 
                        <label>Table Table(if) | F22</label>
                        <input type="text" name="f22" class="form-control"placeholder="eg localemail"value="localemail">
                    </div>
                </div>
			   <div class="col-md-12">
                    <div class="form-group"> 
				...
				<div class="col-md-12">
                    <div class="form-group"> 
						...
						<option value="2">Specific Table</option>
						<option value="3">To Single Person</option>
						</select>					
                    </div>
			  ...
			  <div class="col-md-12">
                    <div class="form-group"> 
                        <label>From Name | F23</label>
                        <input type="text" name="f23" class="form-control"value="NightBird"required>
                    </div>
                </div>
