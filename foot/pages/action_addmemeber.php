...
$count = mysqli_num_rows(Query("SELECT * FROM `member` WHERE `username`='$username'"));
...
$email_count = mysqli_num_rows(Query("SELECT * FROM `member` WHERE `email`='$email'"));
...
if($insett){
	...
	$message = "Dear <b>$fname $lname</b>, <br/><br/>
						<font color='green' size='4'><u>Your BDCard International Virtual Card Account has successfully been created, please click the following Login URL to login into your account. Use the Username or Customer ID provided bellow: </u></font><br/><br/> 
