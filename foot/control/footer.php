<footer>
	<div class="row">
		...
		<div class="col-md-4">
			<div class="panel panel-default">
				<a href="balanceTransfer.php">
					<div class="panel-heading-new" id="new">
					
						<span class="fa fa-caret-right"></span> Balance Transfer
					</div>
				</a>
			</div>
		</div>
		<div class="col-md-4">
			<div class="panel panel-default">
				<a href="recharge_pin.php">
					<div class="panel-heading-new" id="new">
						<span class="fa fa-caret-right"></span> Recharge PIN Generation
					</div>
				</a>
			</div>
		</div>
