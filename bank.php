...
<?php require_once("start_html_head.php"); ?>
		<title>IndoTufan | All India Online Bamk Test Series</title>
		 <meta property="og:site_name" content="IndoTufan">
    
    <meta property="og:title" content="IndoTufan | All India Online Bank Test Series">
    <meta property="og:image" content="img/success2.jpg">
	   ...
	   <meta name="description" content="Participate in All India Online Bank Test Series and boost your capacity. ">
	    <meta name="keywords" content="bank, bank test,free,indotufan.com,indotufan,indo tufan,test,test series,online,online test series,All India Online bank Test Series,aits, AITS">	 
	...
	?><h1 style="font-family: 'Yanone Kaffeesatz', sans-serif;">Bank All India Test Series 2017</h1> <?php
					?>
	...
	if(isset($_REQUEST['id'])){
		...
		$sql2=mysqli_query($con,"select * from all_test where exam_for_display='1' and ready_to_run='1'  and (exam_type='bank_series' or exam_type='bank_support') order by s_no desc limit 0,1");
...
<?php
				  $sqq=mysqli_query($con,"select * from all_test where (exam_type='bank_series' or exam_type='bank_support') and exam_for_display='1' order by s_no desc limit 10");
	...
	<br>
			<section style="background-color:#213948;padding-top:50px;padding-bottom:50px;"id="aboutheading">
				<div class="container">
					...
					require_once("welcome.php");
					$ss=mysqli_query($con,"select * from all_test where exam_for_display='1' and (exam_type='bank_series' or exam_type='bank_support') order by s_no desc ");
					...
					require_once("welcome.php");
					$sql_rank=mysqli_query($con,"select uid from all_test where rank_status='1' and (exam_type='bank_series' or exam_type='bank_support') order by s_no desc limit 0,1");
