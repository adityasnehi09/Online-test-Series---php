		...
		$sqq=mysqli_query($con,"select gate from activateseries");
				 ...
				 if($series_no>0)
				 {
					 while($row=mysqli_fetch_assoc($sqq))
					 {
						...
						$sq=mysqli_query($con,"select * from gate_exam where series_no='$activateseries' and running_status='1' order by s_no desc limit 0,1");
...
<span style="float:left;"><i>Max Duration: <?php echo $time_limit; ?> Minutes <span data-toggle="tooltip" data-placement="bottom" title="This exam will stopped exactly at <?php echo $ending_time; ?> for all students who is giving this examanation"><a href="#">?</a> </span></i></span></p></div>
<br>
<hr>
<div class="row">
