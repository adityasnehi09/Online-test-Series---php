  ...
  if(isset($_POST['submitreg']))
  {
	  ...
	  $sql=mysqli_query($con,"select email from `$tablename`");
		  ...
		  while($row=mysqli_fetch_assoc($sql))
		  {
			...
			$msg=mysqli_real_escape_string($con,$_POST['message']);
	                   ...
	                   $random_password=str_shuffle("1234567890");
                             ...
                             $message .= '<table width="100%"; rules="all"  cellpadding="10"style="border:0px solid white;">';
                             ...
                             $message .= "<tr><td colspan=2>NightBird Team</td></tr>";
                             $message .= "<tr><td colspan=2>www.nightbird.in</td></tr>";
							 ...
							 {
								 echo "<center><p>Message Sent to $emailX</p></center>";
							 }
							 else
							 {
								 echo "<center><p>Sending Failed ($emailX)</p></center>";
							 }
		  }
	  }else{
		  echo mysql_error();?>
