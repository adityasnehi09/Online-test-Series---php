...
<?php require_once("start_html_head.php"); ?>
		...
		<meta name="description" content="PLEASE READ THIS TERMS OF SERVICE AGREEMENT CAREFULLY. BY USING THIS WEBSITE OR ORDERING SERVICES FROM THIS WEBSITE YOU
AGREE TO BE BOUND BY ALL OF THE TERMS AND CONDITIONS OF THIS
AGREEMENT.">
	    <meta name="keywords" content="terms,and ,condition,IndoTufan,about,Indo Tufan, indo tufan,indotufan.com,test series,online ">
	...
	<body>
		...
		<div style="margin-top:20px;background-color:white">
			...
			<p>LAST REVISION: [07-July-2016]<br>
PLEASE READ THIS TERMS OF SERVICE AGREEMENT CAREFULLY. BY
USING THIS WEBSITE OR ORDERING SERVICES FROM THIS WEBSITE YOU
AGREE TO BE BOUND BY ALL OF THE TERMS AND CONDITIONS OF THIS
AGREEMENT.</p>
<p>This Terms of Service Agreement (the "Agreement") governs your use of this
website, indotufan.com (the "Website"), IndoTufan ("Business Name")
offer of services for purchase on this Website, or your purchase of services
available on this Website. This Agreement includes, and incorporates by this
reference, the policies and guidelines referenced below. IndoTufan reserves
the right to change or revise the terms and conditions of this Agreement at any time
by posting any changes or a revised Agreement on this Website. IndoTufan
...
your acceptance of any such changes or revisions. IndoTufan encourages
...
may have with IndoTufan for other products or services. If you do not agree to
...
click the print button on your browser toolbar.</p>
<h4>I. We can update your profile.<h4>
<h4>
II. WEBSITE</h4>
...
about nutritional and dietary supplements. [Business Name] does not always create
the information offered on this Website; instead the information is often gathered
from other sources. To the extent that IndoTufan does create the content on
...
websites are provided solely as a convenience to you. IndoTufan does
not endorse the contents on any such third-party websites. IndoTufan is not
...
<p>Use of Website; IndoTufan is not responsible for any damages resulting from
...
express written authorization from IndoTufan or the applicable third party (if
third party content is at issue).
</p>
<p>
Posting. By posting, storing, or transmitting any content on the Website, you hereby
grant IndoTufan a perpetual, worldwide, non-exclusive, royalty-free,
...
media now known or hereinafter created, anywhere in the world. IndoTufan
...
users of the Website and any content you post. IndoTufan is not liable for any
damage or harm resulting from any posts by or interactions between users.
IndoTufan reserves the right, but has no obligation, to monitor interactions
between and among users of the Website and to remove any content IndoTufan deems objectionable, in MuscleUP Nutrition 's sole discretion.
...
AVAILABLE" BASIS. IndoTufan EXPRESSLY DISCLAIMS ALL
...
WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, IndoTufan
MAKES NO WARRANTY:
...
IndoTufan ENTIRE LIABILITY, AND YOUR EXCLUSIVE REMEDY, IN LAW,
...
IndoTufan WILL NOT BE LIABLE FOR ANY DIRECT, INDIRECT,
...
<p>
You will release, indemnify, defend and hold harmless IndoTufan, and any of
...
supplied to IndoTufan. When IndoTufan is threatened with suit or sued
by a third party, IndoTufan may seek written assurances from you concerning
your promise to indemnify IndoTufan; your failure to provide such assurances
may be considered by IndoTufan to be a material breach of this Agreement.
IndoTufan will have the right to participate in any defense by you of a thirdparty
claim related to your use of any of the Website content or Products, with
counsel of IndoTufan choice at its expense. IndoTufan will reasonably
cooperate in any defense by you of a third-party claim at your request and expense.
You will have sole responsibility to defend IndoTufan against any claim, but
you must receive IndoTufan prior written consent regarding any related
...
<h4>VI. PRIVACY</h4>
<p>
IndoTufan believes strongly in protecting user privacy and providing you with
notice of MuscleUP Nutrition 's use of data. Please refer to IndoTufan privacy
...
<h4>VIII. GENERAL</h4>
<p>Force Majeure. IndoTufan will not be deemed in default hereunder or held
...
Cessation of Operation. IndoTufan may at any time, in its sole discretion and
...
and IndoTufan and supersedes any prior agreements pertaining to the subject
matter contained herein.
Effect of Waiver. The failure of IndoTufan to exercise or enforce any right or
...
Governing Law; Jurisdiction. This Website originates from the [Saharsa, Bihar]. This
Agreement will be governed by the laws of the State of [Bihar] without
regard to its conflict of law principles to the contrary. Neither you nor [IndoTufan]
...
courts located in State of [Bihar]. By using this Website or ordering Products,
...
Termination. IndoTufan reserves the right to terminate your access to the
...
permitted to use the Website and IndoTufan may, in its sole discretion and
without advance notice to you, cancel any outstanding orders for Products. If your
access to the Website is terminated, IndoTufan reserves the right to exercise
whatever means it deems necessary to prevent unauthorized access of the Website.
This Agreement will survive indefinitely unless and until IndoTufan chooses,
in its sole discretion and without advance to you, to terminate it.
Domestic Use. IndoTufan makes no representation that the Website or
...
anyone. IndoTufan may assign its rights and obligations under this
